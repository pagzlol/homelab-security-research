...
**Status:** Contained: host taken offline, rebuild planned
...
| 2026-03-22 | Host taken offline: full rebuild planned |
...
This fits someone logging in, confirming access, then moving on to the
execution stage without touching the config further.
...
### Gap 4: SHA-256 password on a service exposed to the internet
...
host cannot be considered trustworthy and was taken offline.
...
| Ubuntu host taken offline | ✅ Decision made: rebuild planned |
